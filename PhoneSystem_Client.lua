-- ========================================
-- SISTEM HANDPHONE ROBLOX - CLIENT SCRIPT
-- ========================================
-- Pasang script ini di StarterPlayerScripts
-- Script ini akan membuat UI handphone secara otomatis!

print("📱 Memulai sistem handphone client...")
...
-- Wait for PhoneConfig
local PhoneConfig = require(ReplicatedStorage:WaitForChild("PhoneConfig"))
...
function PhoneSystem:CreateUI()
    ...
    self.menuButton.BackgroundColor3 = PhoneConfig.Colors.Primary
    ...
    self.phoneFrame.BackgroundColor3 = PhoneConfig.Colors.Background
...
function PhoneSystem:CreateHeader()
    ...
    self.headerFrame.BackgroundColor3 = PhoneConfig.Colors.Primary
...
function PhoneSystem:CreateNavigation()
    ...
    self.navFrame.BackgroundColor3 = PhoneConfig.Colors.Surface
    ...
    for i, buttonData in ipairs(navButtons) do
        ...
        button.TextColor3 = PhoneConfig.Colors.TextSecondary
...
function PhoneSystem:CreateHomePage()
    ...
    -- Quick actions
    local quickCallButton = self:CreateQuickAction("📞", PhoneConfig:GetText("QuickCall"), PhoneConfig.Colors.Primary)
    quickCallButton.Position = UDim2.new(0, 20, 0, 20)
    quickCallButton.Parent = self.homePage
    
    local quickChatButton = self:CreateQuickAction("💬", PhoneConfig:GetText("QuickChat"), PhoneConfig.Colors.Accent)
    quickChatButton.Position = UDim2.new(0.5, 10, 0, 20)
    quickChatButton.Parent = self.homePage
    
    local groupCallButton = self:CreateQuickAction("👥", PhoneConfig:GetText("GroupCall"), Color3.fromRGB(156, 39, 176))
    groupCallButton.Position = UDim2.new(0, 20, 0, 120)
    groupCallButton.Parent = self.homePage
    
    local contactsButton = self:CreateQuickAction("👤", PhoneConfig:GetText("Contacts"), Color3.fromRGB(255, 152, 0))
...
function PhoneSystem:CreateContactsPage()
    ...
    searchFrame.BackgroundColor3 = PhoneConfig.Colors.Surface
    ...
    self.searchBox.Text = PhoneConfig:GetText("SearchPlayers")
    self.searchBox.TextColor3 = PhoneConfig.Colors.Text
...
function PhoneSystem:CreateChatPage()
    ...
    inputFrame.BackgroundColor3 = PhoneConfig.Colors.Surface
    ...
    self.messageInput.Text = PhoneConfig:GetText("TypeMessage")
    self.messageInput.TextColor3 = PhoneConfig.Colors.Text
    ...
    sendButton.TextColor3 = PhoneConfig.Colors.Text
...
function PhoneSystem:CreateCallsPage()
    ...
    self.muteButton.BackgroundColor3 = PhoneConfig.Colors.Error
    ...
    self.hangUpButton.BackgroundColor3 = PhoneConfig.Colors.Error
...
function PhoneSystem:UpdateNavButtons(selectedButton)
    for _, child in pairs(self.navFrame:GetChildren()) do
        if child:IsA("TextButton") then
            child.TextColor3 = PhoneConfig.Colors.TextSecondary
        end
    end
    
    selectedButton.TextColor3 = PhoneConfig.Colors.Primary
end
...
function PhoneSystem:CreateContactFrame(contact)
    ...
    frame.BackgroundColor3 = PhoneConfig.Colors.Surface
    ...
    avatarFrame.BackgroundColor3 = PhoneConfig.Colors.TextSecondary
    ...
    nameLabel.TextColor3 = PhoneConfig.Colors.Text
    ...
    callButton.BackgroundColor3 = PhoneConfig.Colors.Primary
    callButton.Text = "📞"
    ...
    chatButton.BackgroundColor3 = PhoneConfig.Colors.Accent
    chatButton.Text = "💬"
...
function PhoneSystem:ShowIncomingCall(caller)
    ...
    popup.BackgroundColor3 = PhoneConfig.Colors.Background
    ...
    callerLabel.Text = PhoneConfig:GetText("IncomingCall") .. " " .. caller
    callerLabel.TextColor3 = PhoneConfig.Colors.Text
    ...
    answerButton.BackgroundColor3 = PhoneConfig.Colors.Success
    answerButton.Text = PhoneConfig:GetText("Answer")
    ...
    declineButton.BackgroundColor3 = PhoneConfig.Colors.Error
    declineButton.Text = PhoneConfig:GetText("Decline")
...
function PhoneSystem:ShowMessageNotification(sender, message)
    ...
    notification.BackgroundColor3 = PhoneConfig.Colors.Background
    ...
    senderLabel.TextColor3 = PhoneConfig.Colors.Text
    ...
    messageLabel.TextColor3 = PhoneConfig.Colors.TextSecondary
...
print("🎉 Sistem handphone client berhasil diinisialisasi!")
print("📱 Tombol handphone muncul di kanan tengah layar")
print("🇮🇩 Interface dalam bahasa Indonesia")
print("✨ Fitur tersedia:")
print("   • Panggilan individual dan grup")
print("   • Chat text real-time")
print("   • UI responsif dan modern")
